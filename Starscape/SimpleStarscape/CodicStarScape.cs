...
#pragma warning restore CS0162 // OK, keep nagging about Unreachable code detected
        ...
        private void CreateCampusMölndalSign()
        {
            var text = new string[7];
            var row = 0;
            text[row++] = (@"                                                           /\  /\                                       ");
            text[row++] = (@"_________                                          _____   \/  \/.__              .___      .__         ");
            text[row++] = (@"\_§§§___§\_____§§§§_____§______§§__§__§§______§§§§/§§§§§\§§§____§|§§|§§§____§§§§__|§_/____§§|§§|§§§§§§§§");
            text[row++] = (@"/§§§§\§§\/\__§§\§§/§§§§§\\____§\|§§|§§\/§§___/§§§/§§\§/§§\§/§§_§\|§§|§§/§§§§\§§/§__§|\__§§\§|§§|§§§§§§§§");
            text[row++] = (@"\§§§§§\____/§__§\|§§Y§Y§§\§§|_>§>§§|§§/\___§\§§§/§§§§Y§§§§(§§<_>§)§§|_|§§§|§§\/§/_/§|§/§__§\|§§|__§§§§§§");
            text[row++] = (@"§\______§§(____§§/__|_|§§/§§§__/|____//____§§>§§\____|__§§/\____/|____/___|§§/\____§|(____§§/____/§     ");
            text[row++] = (@"        \/     \/      \/|__|              \/           \/                 \/      \/     \/            ");

            for (var i = 0; i < text.Length; i++)
            {
                sh.Center(LayerType.TextLogo, 5 + i, text[i].Replace(' ', '\0').Replace('§', ' '));
            }
        }
